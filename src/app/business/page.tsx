...
import { ArrowRight, BarChart, Building2, CheckCircle, Users } from 'lucide-react'
      ...
      */}
      ...
      <section className="pt-[7rem] pb-20 px-4">
        <div className="container mx-auto max-w-6xl text-center">
          <h1 className="text-4xl md:text-6xl font-normal tracking-tight">
            Your Hiring, <span className="text-accent-blue-1 font-semibold">Superfast.</span>
          </h1>
          <p className="mt-6 text-xl text-gray-600 max-w-2xl mx-auto">
            Tired of juggling job postings across platforms? Still not getting qualified candidates ? Try GetJobs.Today to hire superfast !
          </p>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl font-bold text-center mb-12">Why Choose GetJobs.Today?</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-2xl">
              <div className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center mb-4">
                <BarChart className="w-6 h-6 text-accent-blue-1" />
              </div>
              <h3 className="text-xl font-semibold mb-2">Effortless Dashboard</h3>
              <p className="text-gray-600">
                Stay organized with our user-friendly dashboard. Easily post jobs, track views, and manage listings.
              </p>
            </div>
            <div className="bg-white p-6 rounded-2xl">
              <div className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center mb-4">
              ...
              <p className="text-gray-600">
                Post jobs for different brands, subsidiaries, or teams from a single login. No extra accounts needed.
              </p>
            </div>
            <div className="bg-white p-6 rounded-2xl">
              <div className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center mb-4">
              ...
              <p className="text-gray-600">
                We generate a sleek company profile that you can link to your website. No career page needed.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div>
              <div className="text-4xl font-bold text-accent-blue-1 mb-2">10,000+</div>
              <p className="text-gray-600">Monthly Active Job Seekers</p>
            </div>
            <div>
              <div className="text-4xl font-bold text-accent-blue-1 mb-2">5,000+</div>
              <p className="text-gray-600">Job Alerts Sent Monthly</p>
            </div>
            <div>
              <div className="text-4xl font-bold text-accent-blue-1 mb-2">2 Weeks</div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-2xl border border-gray-200">
              ...
              <div className="text-3xl font-bold mb-4">$71 <span className="text-lg font-normal text-gray-600">/30 days</span></div>
            ...
            <div className="bg-white p-6 rounded-2xl border-2 border-blue-600 relative">
              ...
              <div className="text-3xl font-bold mb-4">$120 <span className="text-lg font-normal text-gray-600">/30 days</span></div>
              <ul className="space-y-3">
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-5 h-5 text-green-500" />
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-200">
              ...
              <div className="text-3xl font-bold mb-4">$499 <span className="text-lg font-normal text-gray-600">/30 days</span></div>
              <ul className="space-y-3">
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-5 h-5 text-green-500" />
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl text-center">
          <h2 className="text-3xl md:text-4xl font-medium mb-6">Ready to Hire Superfast?</h2>
      ...
      <footer className="py-12 px-4 bg-gray-50">
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="text-gray-600">© 2024 GetJobs.Today. All rights reserved.</div>
          </div>
        </div>
      </footer>
    </div>
