...
export default function Home() {
  ...
  return (
    <div className="max-w-[73.75rem] mx-auto flex flex-col items-center justify-center gap-[2rem] overflow-x-hidden">
      <Navbar />
      ...
      <div className="w-[100%] text-center flex flex-col items-center justify-center gap-[1rem] p-[1rem] mt-[1rem]">
        ...
        <div
          className="w-[12rem] md:w-[16rem] browse-button ease-in-out flex items-center justify-center gap-[0.5rem] md:gap-[1rem] mt-[1rem] text-[16px] md:text-[20px] p-[12px] md:p-[16px] button-primary bg-accent-blue-1 border-accent-blue-1 active:w-[80%] focus:w-[80%]"
          style={{
        ...
        <p className="text-base-2 text-[14px]">No Login required</p>
      </div>
