      ...
      <div className="max-w-[54.75rem] mx-auto p-[1rem]">
        <div className=" bg-background rounded-[1rem] p-[1rem] flex flex-col gap-[1rem] my-[2rem] ">
          ...
          <p>
            ...
            GetJobs.Today and any other of GetJobs' sites, apps, accounts on any
            platform, and/or any of its online or offline events or properties.
          </p>
          ...
          <ul>
            <li>
              ...
              crowdsourced and have user-generated content, so don't rely on the
              data.
            </li>
            <li>
            ...
            <li>
              ...
              you're required to link back to us on every page or in every app
              screen you use the data on.
            </li>
            <li>
          ...
          <ol>
            <li>
              ...
              <p>
                ...
                inconvenience resulting from using GetJobs.Today's websites and
                apps. You should verify critical information.
              </p>
              <p>
            ...
            <li>
              ...
              <p>
                ...
                However, materials contained in GetJobs.Today's websites, apps,
                communities, and its properties are subject to change at any
                time by appropriate action of GetJobs. We give no assurance or
                warranty that information on this site is current and take no
            ...
            <li>
              ...
              <p>
                Copyright in GetJobs.Today's websites, apps, communities, and
                its properties rests with GetJobs unless otherwise stated.
              </p>
            </li>
            <li>
            ...
            <li>
              ...
              <p>
                In the event a User's Payment Method was declined, GetJobs may
                attempt to process the transaction again under the same
            ...
            <li>
              ...
              <p>
                GetJobs.Today's websites, apps, communities, and its properties
                are provided on an “as is”, “as available” basis without
                warranties of any kind, express or implied, including, but not
                limited to, those of TITLE, MERCHANTABILITY, FITNESS FOR A
                PARTICULAR PURPOSE, or NON-INFRINGEMENT or any warranty arising
                from a course of dealing, usage, or trade practice. No advice or
                ...
                advice. This publication is not intended to be a contract,
                explicit or implied, and GetJobs reserves the right to make
            ...
            <li>
              ...
              <p>
                ...
                GetJobs.Today's websites, apps, communities, and its properties
                and the Internet generally. We accept no liability or
            ...
            <li>
              ...
              <p>
                GetJobs.Today's software, apps, website, communities, and any of
                its other properties are provided "as is", without warranty of
                any kind, express or implied, including but not limited to the
                warranties of MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE,
                and NON-INFRINGEMENT. In no event shall the authors, owners, or
                copyright holders be liable for any claim, damages, or other
                liability, whether in an action of contract, tort, or otherwise,
                arising from, out of, or in connection with GetJobs.Today's
                software, apps, website, communities, and any of its other
                properties or the use or other dealings in GetJobs.Today's
                software, apps, website, communities, and any of its other
                properties.
              </p>
            </li>
            <li>
              ...
              <p>
                Visitors agree to use the Website only for lawful purposes and
                are prohibited from posting on the Website any unlawful,
                harmful, threatening, abusive, harassing, defamatory, or obscene
                material of any kind, including, but not limited to, any
                material which encourages conduct that would constitute a
                criminal offense, give rise to civil liability, or otherwise
                violate any applicable local, state, national, or international
                law. Although in the absence of a specific complaint the
                postings are monitored for compliance with this provision, in an
                effort to discourage such conduct, please note that all postings
                in any forum area will list the author’s name and institution -
                no anonymous postings will be permitted.
              </p>
            </li>
            <li>
              ...
              <p>
                ...
                editorial control over this content than does a public library.
                Any opinions, advice, statements, services, offers, or other
                information or content made available by members, visitors, and
                other third parties are those of the respective author(s) and we
                are not responsible for any material posted by third parties. We
                cannot and do not endorse it in any way; we expressly disclaim
                any liability associated with material posted by third parties.
              </p>
            </li>
            <li>
              ...
              <p>
                ...
                hypertext link to third parties, or other information by trade
                name, trademark, supplier, or otherwise does not constitute or
                imply its endorsement, sponsorship, or recommendation by us. Nor
                is endorsement of us implied by such links. They are for
                convenience only, as an index in a public library.
              </p>
            </li>
            <li>
              <strong>Changes and Errors</strong>:
              <p>
                Any information on GetJobs.Today's websites, apps, communities,
                and its properties may include technical inaccuracies or
                typographical errors. Furthermore, the information may change
            ...
            <li>
              ...
              <p>
                You agree to observe and maintain the confidentiality of all
                security features relating to the use of the Website (including
                passwords, access arrangements, etc.) as notified. GetJobs will
                not be liable for any unauthorized breach or disclosure of the
                security features.
              </p>
            </li>
            <li>
              <strong>Link Back</strong>:
              <p>
                You agree to link back with a web hyperlink or in-app hyperlink
                to our site on the page or app screen where you use the data
                from our APIs or site.
              </p>
            </li>
            <li>
              <strong>User Data Usage</strong>:
              <p>
                Your user data may be used on any of our websites and apps,
                including marketing pages, to show current user activity.
              </p>
            </li>
            <li>
              <strong>Feedback Property</strong>:
              <p>
                When providing feedback (e.g. by identifying any errors or
                problems in the operations of GetJobs and its services) through
                any medium (e.g. the feedback form, email, or any other medium),
                you acknowledge and agree that all feedback will be the sole and
                exclusive property of GetJobs. You hereby assign to GetJobs and
                agree to assign to GetJobs all of your right and interest in and
                to all feedback, including all intellectual property rights
                therein.
              </p>
            </li>
            <li>
              ...
              <p>
                You agree to indemnify GetJobs (its employees and agents) for
                any loss suffered or liability incurred by GetJobs (its
                employees and agents) arising from any unlawful, unauthorized,
                or improper access or use of the Website or any breach of these
                terms by you or your employees, contractors, or representatives.
              </p>
            </li>
            <li>
              <strong>Availability</strong>:
              <p>
                GetJobs does not guarantee constant availability of Website
                access and accepts no liability for downtime or access failure
                due to circumstances beyond its reasonable control (including
                any failure by ISP or system provider).
              </p>
            </li>
            <li>
              <strong>Linked Sites</strong>:
              <p>
                The Site may contain links to other sites on the internet
                (“Linked Sites”). GetJobs is not responsible for the accuracy,
                legality, decency of material, or copyright compliance of any
                Linked Site or services or information provided via any Linked
                Site.
              </p>
            </li>
            <li>
              ...
              <p>
                ...
                totally secure. While we strive to protect such information, we
                do not warrant and cannot ensure the security of information
            ...
            <li>
              ...
              <p>
                These terms and conditions will be construed according to and
                are governed by the laws of India, regardless of where GetJobs
                operates or you use GetJobs from.
              </p>
            </li>
          </ol>
        </div>
