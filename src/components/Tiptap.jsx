...
const Tiptap = ({ setDesc, oldDesc }) => {
  ...
  const setLink = useCallback(() => {
    ...
    const url = window.prompt(
      'Please enter the URL you want to embed "https://..." ',
      previousUrl
    );
    ...
    <div className="w-[100%] flex flex-col gap-[1rem]">
      <div className="flex-grow-0 bg-background flex justify-start gap-[1rem] p-[0.5rem] rounded-[12px] text-[1rem]">
        ...
        <button
          ...
          } bg-white px-[0.75rem] py-[0.5rem] rounded-[8px] font-bold`}
        >
          B
        </button>
        ...
        <button
          ...
          } bg-white px-[0.75rem] py-[0.5rem] rounded-[8px] font-serif italic`}
        >
          I
        </button>
        ...
        <button
          ...
          } bg-white px-[0.75rem] py-[0.5rem] rounded-[8px]`}
        >
          <FaListUl />
        </button>
